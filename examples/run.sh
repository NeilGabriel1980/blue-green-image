...
docker run -d --rm --network $ENV_NETWORK --name green    -e COLOR=red neilgabriel/blue-green-image
docker run -d --rm --network $ENV_NETWORK --name blue     -e COLOR=yellow  neilgabriel/blue-green-image
